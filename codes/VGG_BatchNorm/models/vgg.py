...
class VGG_A_BatchNorm(nn.Module):
    ...
    BN is added after each convolutional layer, before ReLU activation.
    """
...
if __name__ == '__main__':
    print('VGG_A parameters:', get_number_of_parameters(VGG_A()))
    print('VGG_A_Light parameters:', get_number_of_parameters(VGG_A_Light()))
    print('VGG_A_Dropout parameters:', get_number_of_parameters(VGG_A_Dropout()))
    print('VGG_A_BatchNorm parameters:', get_number_of_parameters(VGG_A_BatchNorm()))